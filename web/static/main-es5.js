(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    0: function _(module, exports, __webpack_require__) {
      ...
      /*! /home/roy/code/new_architecture/prisonautomation/tmp/prisonemr/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    "4XPS": function XPS(module, __webpack_exports__, __webpack_require__) {
      ...
      var RegisterComponent = /*#__PURE__*/function () {
        function RegisterComponent(authService, router, _activatedroute) {
          ...
          this.selected_val = "";
          this.name = 'Angular 4';
          this.items = ['Ant-Man', 'Aquaman', 'Asterix', 'The Atom', 'The Avengers', 'Batgirl', 'Batman', 'Batwoman'];
          this.origItems = ['Ant-Man', 'Aquaman', 'Asterix', 'The Atom', 'The Avengers', 'Batgirl', 'Batman', 'Batwoman'];
          this.authService.getPeople().subscribe(function (data) {
            var sel = document.getElementById('patient_id');

            var _loop = function _loop() {
              person_id = data[i].person_id; //const names =  data[i]['person_attributes'];

              var attributes = data[i]['person_attributes'];
          ...
          this.authService.getRoles().subscribe(function (data) {
            ...
            result.forEach(function (op) {
              return usersroles.innerHTML += "<option>".concat(op, "</option>");
            });
          }, function (error) {
            console.log(error);
          });
        ...
        _createClass(RegisterComponent, [{
          ...
          value: function filterItem(event) {
            ...
            if (typeof event === 'string') {
              this.items = this.origItems.filter(function (a) {
                return a.toLowerCase().startsWith(event.toLowerCase());
              });
          ...
          value: function _function() {
            ...
            this.registerForm.controls.password.valueChanges.subscribe(function (x) {
              return _this.registerForm.controls.cnfpass.updateValueAndValidity();
            });
          }
        }, {
          key: "isValid",
          ...
          value: function register() {
            ...
            console.log(this.registerForm.value); //const secretkeyval = this.registerForm.value.secretkey
            //if(secretkeyval === "prisonemr2021"){

            this.authService.submitRegister(this.registerForm.value).subscribe(function (data) {
              console.log(data);
              _this2.alert = true;
    ...
    /***/
    "9S6d": function S6d(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FilterPipe = /*#__PURE__*/function () {
        ...
        _createClass(FilterPipe, [{
           ...
           * @returns {any[]}
           */
          function transform(items, searchText) {
            if (!items) {
              return [];
            }
    ...
    "AytR": function AytR(module, __webpack_exports__, __webpack_require__) {
      ...
      var environment = {
        production: false,
        backend_base_url: 'http://localhost:3000/api/v1' //production: false,
    ...
    "JPqG": function JPqG(module, __webpack_exports__, __webpack_require__) {
      ...
      var DefaultLayoutComponent = /*#__PURE__*/function () {
        function DefaultLayoutComponent(authService, router, _activatedroute, datepipe) {
    ...
    "QB/w": function QBW(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(authService, router, _activatedroute) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login() {
            ...
            this.authService.submitLogin(this.loginForm.value).subscribe(function (data) {
    ...
    "Sy1n": function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _coreui_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @coreui/icons */
      "t17N");

      var AppComponent = function AppComponent(iconSet) {
    ...
    "ZAI4": function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var ngx_electron__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ngx-electron */
      "31Lz");
      /* harmony import */
      ...
      var _views_error_404_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./views/error/404.component */
      "8gg5");
      /* harmony import */


      var _views_error_500_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./views/error/500.component */
      "dxhq");
      /* harmony import */


      var _views_login_login_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./views/login/login.component */
      "QB/w");
      /* harmony import */


      var _views_register_register_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./views/register/register.component */
      "4XPS");
      /* harmony import */


      var _views_register_filter_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./views/register/filter.pipe */
      "9S6d");
      /* harmony import */
      ...
      var ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ngx-bootstrap/tabs */
      "44PX");
      ...
      var APP_CONTAINERS = [_containers__WEBPACK_IMPORTED_MODULE_15__["DefaultLayoutComponent"]]; // Import 3rd party components
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"]].concat(APP_CONTAINERS, [_views_error_404_component__WEBPACK_IMPORTED_MODULE_16__["P404Component"], _views_error_500_component__WEBPACK_IMPORTED_MODULE_17__["P500Component"], _views_login_login_component__WEBPACK_IMPORTED_MODULE_18__["LoginComponent"], _views_register_register_component__WEBPACK_IMPORTED_MODULE_19__["RegisterComponent"], _views_register_filter_pipe__WEBPACK_IMPORTED_MODULE_20__["FilterPipe"]]),
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_12__["AppRoutingModule"], ngx_electron__WEBPACK_IMPORTED_MODULE_13__["NgxElectronModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_21__["AppAsideModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_21__["AppBreadcrumbModule"].forRoot(), _coreui_angular__WEBPACK_IMPORTED_MODULE_21__["AppFooterModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_21__["AppHeaderModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_21__["AppSidebarModule"], ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_14__["PerfectScrollbarModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_22__["BsDropdownModule"].forRoot(), ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_23__["TabsModule"].forRoot(), //ChartsModule,
        _coreui_icons_angular__WEBPACK_IMPORTED_MODULE_4__["IconModule"], _coreui_icons_angular__WEBPACK_IMPORTED_MODULE_4__["IconSetModule"].forRoot(), ngx_toastr__WEBPACK_IMPORTED_MODULE_10__["ToastrModule"].forRoot()],
        providers: [{
          provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"],
          useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicRouteStrategy"]
        }, _coreui_icons_angular__WEBPACK_IMPORTED_MODULE_4__["IconSetService"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"]],
    ...
    "lGQG": function lGQG(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        ...
        _createClass(AuthService, [{
          ...
          key: "currentModuleValue",
          value: function currentModuleValue() {
            return this.currentModule;
          }
        }, {
          key: "setModule",
          value: function setModule(data) {
          ...
          value: function extractData(data) {
            ...
            this.chauser = {
              "userId": data.authorization.user.user_id,
          ...
          key: "submitLogin",
          value: function submitLogin(body) {
            var _this4 = this;
            ...
            return this._http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].backend_base_url + "/auth/login", body, {
              ...
              return _this4.extractData(user);
            }));
          }
        }, {
          key: "submitRegister",
          ...
          key: "addGlobalProperty",
          value: function addGlobalProperty(body) {
          ...
          value: function getGlobalProperty(body) {
          ...
          key: "submitPerson",
          value: function submitPerson(body) {
          ...
          key: "changePerson",
          value: function changePerson(body) {
          ...
          key: "submitPatient",
          value: function submitPatient(body) {
          ...
          key: "addPatientIdentifier",
          value: function addPatientIdentifier(body) {
          ...
          key: "saveEncounter",
          value: function saveEncounter(body) {
          ...
          key: "enrollPatient",
          value: function enrollPatient(body) {
            var patient_id = body.person_id;
          ...
          key: "getRegimens",
          value: function getRegimens(body) {
          ...
          key: "getPrisons",
          value: function getPrisons(body) {
          ...
          key: "getPrisoners",
          value: function getPrisoners(body) {
          ...
          key: "getProgrampatients",
          value: function getProgrampatients(body) {
          ...
          key: "getPrisonerEncounters",
          value: function getPrisonerEncounters(body) {
          ...
          key: "patientSearch",
          value: function patientSearch(body) {
          ...
          key: "patientIdentity",
          value: function patientIdentity(body) {
          ...
          key: "getPrograms",
          value: function getPrograms(body) {
          ...
          key: "getWorkflows",
          value: function getWorkflows(body) {
          ...
          key: "changePatientState",
          value: function changePatientState(body) {
          ...
          key: "getEncounterObs",
          value: function getEncounterObs(body) {
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~views-base-base-module~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-w~7c6aba0a"), __webpack_require__.e("default~views-base-base-module~views-dashboard-dashboard-module~views-icons-icons-module"), __webpack_require__.e("default~views-base-base-module~views-dashboard-dashboard-module"), __webpack_require__.e("views-base-base-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~views-base-base-module~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-w~7c6aba0a"), __webpack_require__.e("default~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-widgets-widgets-module"), __webpack_require__.e("views-chartjs-chartjs-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~views-base-base-module~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-w~7c6aba0a"), __webpack_require__.e("default~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-widgets-widgets-module"), __webpack_require__.e("default~views-base-base-module~views-dashboard-dashboard-module~views-icons-icons-module"), __webpack_require__.e("default~views-base-base-module~views-dashboard-dashboard-module"), __webpack_require__.e("views-dashboard-dashboard-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~views-base-base-module~views-dashboard-dashboard-module~views-icons-icons-module"), __webpack_require__.e("views-icons-icons-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~views-theme-theme-module~views-widgets-widgets-module"), __webpack_require__.e("views-theme-theme-module")]).then(__webpack_require__.bind(null,
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~views-base-base-module~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-w~7c6aba0a"), __webpack_require__.e("default~views-chartjs-chartjs-module~views-dashboard-dashboard-module~views-widgets-widgets-module"), __webpack_require__.e("default~views-theme-theme-module~views-widgets-widgets-module"), __webpack_require__.e("views-widgets-widgets-module")]).then(__webpack_require__.bind(null,
